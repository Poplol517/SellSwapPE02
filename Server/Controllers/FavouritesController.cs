...
namespace SellSwap.Server.Controllers
{
    ...
    public class FavouritesController : ControllerBase
    {
        ...
        public async Task<IActionResult> GetFavourites()
        {
            ...
            var favourites = await _unitOfWork.Favourites.GetAll(includes: q => q.Include(x => x.Listing).Include(x => x.Listing.ListingType).Include(x => x.Listing.Category).Include(x => x.Account));
